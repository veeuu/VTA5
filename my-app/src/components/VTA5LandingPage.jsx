...
const GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyfATxCSgfFsFNmTHYcbAnyVdXf69TBvw_vuz0WrR14d3HKHcJo/exec';
            ...
            <section className="w-full py-24" style={{ marginTop: '80px', minHeight: 'calc(100vh - 80px)', display: 'flex', alignItems: 'center' }}>
                <div className="max-w-screen-xl px-6 text-center">
                    <div style={{ animation: 'fadeIn 1s ease-out' }}>
                        <h1 className="hero-title gradient-text" style={{ fontWeight: 'bold', marginBottom: '1.5rem' }}>
